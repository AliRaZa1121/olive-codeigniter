...
$route['api/all_categories'] = 'api/Api/all_categories';

$route['api/categories_all'] = 'controllers/api/categories_all';

$routes['api/signups'] = 'controllers/api/sign_up';


$routes['api/employeess'] = 'controllers/Example/index';
