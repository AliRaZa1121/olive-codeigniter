<div class="col-lg-9  order-md-1 course_col" id = "video_player_area">
    ...
    <div class="">
        ...
        <?php elseif ($lesson_details['lesson_type'] == 'other' && $lesson_details['attachment_type'] == 'doc'): ?>
            <div class="mt-5">
                <div class = "col-md-12">
                    <a href="javascript:void(0)"  onclick="openattachementModal(this)" content="https://docs.google.com/gview?url=<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>&embedded=true" class="btn btn-sign-up" style="color: #000;">
                        <i class="fa fa-eye" style="font-size: 20px;"></i> <?php echo $lesson_details['title']; ?>
                    </a>
                </div>
                
            </div>
        
        <?php elseif ($lesson_details['lesson_type'] == 'other' && $lesson_details['attachment_type'] == 'txt'): ?>
            <div class="mt-5">
                <div class = "col-md-12">
                    <a href="javascript:void(0)" onclick="openattachementModal(this)" content="https://docs.google.com/gview?url=<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>&embedded=true" class="btn btn-sign-up"  style="color: #000;">
                        <i class="fa fa-eye" style="font-size: 20px;"></i> <?php echo $lesson_details['title']; ?>
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <div class="mt-5">
                    <a href="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>" class="btn btn-sign-up" target="_blank" style="color: #000;">
                        <i class="fa fa-eye" style="font-size: 20px;"></i> <?php echo get_phrase('View').' '.$lesson_details['title']; ?>
                    </a>
                </div>
            <?php endif; ?>
        <?php endif; ?>
