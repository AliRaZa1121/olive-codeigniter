                                    ...
                                    <div class="my-course-search-bar">
                                        <form action="">
                                            <div class="input-group">
                                                <input type="text" class="form-control py-2" placeholder="<?php echo site_phrase('search_my_courses'); ?>"
                                       ...
                                       <div class="btn-group">
                                            <a href="<?php echo site_url('home/my_courses'); ?>" class="btn reset-btn" disabled>
                ...
                $instructor_details = $this->user_model->get_all_user($course_details['user_id'])->row_array();?>
                    ...
                    <div class="course-box-wrap">
                            <div class="course-box">
                                <a class="course-image-cover" href="<?php echo site_url('home/lesson/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>">
                                ...
                                <div class="course-information" id = "course_info_view_<?php echo $my_course['course_id'];  ?>">
                                  ...
                                  <div class="row">
                                      <div class="col-md-12 px-4 py-2">
                                          <div class="btn-group">
                                               <a href="<?php echo site_url('home/course/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>" class="theme-btn primary-btn btn radius-5"><?php echo site_phrase('course_detail'); ?></a>
