    ...
    <div class="container">
        <div class="row mb-3 mt-0">
          <div class="col-md-12 text-center">
            <h1 class="fw-700">Oganization Registration Form</h1>  
            <p class="text-14px"><?php echo site_phrase('sign_up_and_became_an_organization'); ?></p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6 d-none d-lg-block text-center">
            <img class="mt-5" width="80%" src="<?php echo base_url('assets/payment/Classroom-bro.png'); ?>">
