                                    ...
                                    <?php foreach ($lessons as $lesson): ?>
                                        ...
                                        <tr style="width: 100%; padding: 5px 0px;">
                                            <td style="text-align: left;padding:10px; border-bottom:1px solid #ccc;">
                                                <a hidden href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$course_id.'/'.$lesson['id']); ?>" id = "<?php echo $lesson['id']; ?>">
                                                ...
                                                <a  href="<?php echo base_url() .'/uploads/lesson_files/'. $lesson['attachment']; ?>" target="_blank" id = "<?php echo $lesson['id']; ?>">
                                                    <i class="fa fa-play" style="font-size: 12px;color: #909090;padding: 10px;"></i>
                                                    <?php if ($lesson['lesson_type'] != 'other'):?>
                                                        <?php echo $lesson['title']; ?>
                                                    <?php else: ?>
        ...
        <?php if (isset($lesson_id)): ?>
            <div class="col-lg-9" id = "video_player_area">
                ...
                <div class="" style="text-align: center;">
                    ...
                    <?php else: ?>
                        <div class="mt-5">
                            <a href="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>" class="btn btn-sign-up" target="_blank" style="color: #fff;">
