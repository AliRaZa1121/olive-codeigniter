    ...
    <div class="row align-items-end">
      <div class="col-lg-8">
        <div class="course-breadcrumb">
            <ul>
                <?php 
                    $category_hierarchy = $this->crud_model->category_hierarchy($course_details['sub_category_id']);
        ...
        <div class="course-header-wrap">
          ...
          <div class="rating-row">
            ...
            <span class="enrolled-num">
              ...
              echo $number_of_enrolments . ' ' . site_phrase('trainees_enrolled');
              ?>
            </span>
    ...
    <div class="row">
      <div class="col-lg-8 order-last order-lg-first radius-10 mt-4 bg-white p-30-40">
        ...
        <div class="description-box view-more-parent course-border">
          ...
          <div class="description-title"><?php echo (($course_details['type']==1)?'Course ':'Program ').'Overview'; ?></div>
        ...
        <?php if ($course_details['course_type'] == 'general') : ?>
          <div class="course-curriculum-box">
            <div class="course-curriculum-title clearfix mt-5 mb-3">
              <div class="title float-start"><?php  echo 'Curriculum for this '.(($course_details['type']==1)?'Course ':'Program '); ?></div>
        ...
        <div class="compare-box view-more-parent">
          ...
          <div class="compare-title"><?php  echo 'Other related '.(($course_details['type']==1)?'Courses ':'Programs '); ?></div>
        ...
        <div class="about-instructor-box">
          <div class="about-instructor-title">
            <?php echo site_phrase('about_coach'); ?>
          </div>
          <?php if ($course_details['multi_instructor']) : ?>
            <?php $instructors = $this->user_model->get_multi_instructor_details_with_csv($course_details['user_id']); ?>
            <?php foreach ($instructors as $key => $instructor) : ?>
        ...
        <div class="course-sidebar natural c-shadow">
          <?php if ($course_details['video_url'] != "") : ?>
            <div class="preview-video-box">
              <a data-bs-toggle="modal" data-bs-target="#CoursePreviewModal">
                ...
                <span class="preview-text"><?php echo 'Preview this '.(($course_details['type']==1)?'Course ':'Program ') ?></span>
          ...
          <div class="course-sidebar-text-box">
            ...
            <div class="includes">
              ...
              <div class="title"><b><?php echo 'This '.(($course_details['type']==1)?'Course ':'Program ').' includes'; ?>:</b></div>
              <ul>
                <?php if ($course_details['course_type'] == 'general') : ?>
                ...
                <li class="text-center pt-3">
                  <a class="badge-sub-warning text-decoration-none fw-600 hover-shadow-1 d-inline-block" href="<?php echo site_url('home/compare?course-1=' . rawurlencode(slugify($course_details['title'])) . '&course-id-1=' . $course_details['id'].'&course_type='. $course_details['type']); ?>"><i class="fas fa-balance-scale"></i> 
                  <?php echo " Compare this ".(($course_details['type']==1)?'Course ':'Program ')." with other"; ?>
                  </a>
                </li>
              </ul>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content course-preview-modal">
        <div class="modal-header">
          <h5 class="modal-title"><span><?php echo (($course_details['type']==1)?'Course ':'Program ').' Preview'  ?>:</span><?php echo $course_details['title']; ?></h5>
        ...
        <div class="modal-body">
          <div class="course-preview-video-wrap">
            ...
            <div class="sample-videos">
                    ...
                    <?php 
                      $sample_videos = $this->crud_model->get_sample_videos_by_course_id($course_details['id'])->result_array();
