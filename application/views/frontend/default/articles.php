...
section.org-first-fold, section.arc-first-fold {
    background-image: url(<?php echo base_url('uploads/olive-images/articles.jpeg'); ?>);
                        ...
                        <div class="col-lg-6">
                            <div class="article-box">
                                <div class="article-box-image">
                                    <a href="<?php echo site_url('home/content/articles/' . $article['slug']); ?>"><img class="img-fluid" src="<?php echo base_url('uploads/thumbnails/category_thumbnails/' . $article['thumbnail']); ?>" alt=""></a>
                                    <!-- <span class="article-box-category">category</span> -->
                                </div>
                                <div class="article-box-content">
                                    <h4 class="article-box-title"><?php echo  substr($article['name'], 0, 40); ?></h4>
                                    <p class="article-box-discription"> <?php echo html_entity_decode(substr($article['description'], 0, 100)); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
