                        ...
                        <li>
                            <div class="course-box-2">
                                <div class="course-image">
                                    <a href="<?php echo site_url('home/program/'.slugify($course['title']).'/'.$course['id']) ?>">
                                        <img src="<?php echo $this->crud_model->get_course_thumbnail_url($course['id']); ?>" alt="" class="img-fluid">
                                    </a>
                                </div>
                                <div class="course-details">
                                    <a href="<?php echo site_url('home/program/'.slugify($course['title']).'/'.$course['id']) ?>" class="course-title"><?php echo $course['title']; ?></a>
