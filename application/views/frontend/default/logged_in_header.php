...
?>
<section class="print-hidden menu-area bg-white">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <!-- <form class="inline-form" action="<?php echo site_url('home/search'); ?>" method="get" style="width: 100%;">
                <div class="input-group search-box mobile-search">
                    <input type="text" name='query' class="form-control" placeholder="<?php echo site_phrase('search_for_courses_/_consultancy_programs'); ?>">
            ...
            <!-- <?php if (get_settings('allow_instructor') == 1 && $this->session->userdata('is_organization') != 1) : ?>
            ...
            <!-- <?php if (get_settings('allow_organization') == 1  && $this->session->userdata('is_instructor') != 1) : ?>
                <div class="instructor-box menu-icon-box">
                    <div class="icon">
                        <a href="<?php echo site_url('user'); ?>" style="border: 1px solid transparent; margin: 0px;     padding: 0px 10px; font-size: 14px; width: max-content; border-radius: 5px; height: 40px; line-height: 40px;"><?php echo site_phrase('organization'); ?></a>
                    </div>
                </div>
            <?php endif; ?> -->
            ...
            <div class="instructor-box menu-icon-box">
                <div class="icon">
                    <a href="<?php echo site_url('home/my_programs'); ?>" style="border: 1px solid transparent; margin: 0px;     padding: 0px 10px; font-size: 14px; width: max-content; border-radius: 5px; height: 40px; line-height: 40px;"><?php echo site_phrase('my_programs'); ?></a>
                </div>
            </div>
            <?php endif; ?> -->
            ...
            <?php if ($this->session->userdata('admin_login') == true) { ?>
                <div class=" btn-group menu-icon-box">
                    <div class="icon">
                        <a href="<?php echo site_url('admin/dashboard'); ?>" style="border: 1px solid transparent; margin: 0px; font-size: 14px; width: max-content; border-radius: 5px; max-height: 40px; line-height: 40px; padding: 0px 10px;"><?php echo site_phrase('Adminstrator'); ?></a>
                    </div>
                </div>
            <?php }else { ?>
