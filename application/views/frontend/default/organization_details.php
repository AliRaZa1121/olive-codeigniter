        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="course-header-wrap">
                    <h1 class="title"><?php echo $organization['name']; ?></h1>
            ...
            <div class="col-lg-4">
                <div class="detail-image">
                    <img class="img-fluid" src="<?php echo base_url('uploads/thumbnails/category_thumbnails/' . $organization['banner']); ?>">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="description-box view-more-parent course-border">
                    ...
                    <div class="description-content-wrap">
                        <div class="description-content">
                            <?php echo html_entity_decode($organization['description']) ?>
                        </div>
                    </div>
                </div>
