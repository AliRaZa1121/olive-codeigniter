        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="course-header-wrap">
                    <h1 class="title"><?php echo $content['name']; ?></h1>
                    ...
                    <div class="created-row">
                        ...
                        <br>
                        <span class="last-updated-date d-inline-block mt-2"><i class="fas fa-exclamation-circle"></i><?php echo site_phrase('last_updated') . ' ' . date('D, d-M-Y', $content['last_modified']); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="detail-image">
                    <img class="img-fluid" src="<?php echo base_url('uploads/thumbnails/category_thumbnails/' . $content['thumbnail']); ?>" />
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="description-box view-more-parent course-border">
                    ...
                    <div class="description-content-wrap">
                        <div class="description-content">
                            <?php echo html_entity_decode($content['description']) ?>
                        </div>
                    </div>
                </div>
