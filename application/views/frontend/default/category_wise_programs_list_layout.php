<ul>
    <?php foreach ($programs as $course) :
        ...
        <li>
            <div class="course-box-2 c-shadow">
                <div class="course-image">
                    <a href="<?php echo site_url('home/program/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']) ?>">
                        <img src="<?php echo $this->crud_model->get_programs_thumbnail_url($course['id']); ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <div class="course-details">
                    <a href="<?php echo site_url('home/program/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="course-title"><?php echo $course['title']; ?></a>
                            ...
                            <div class="col-md-12">
                                <?php if ($course['course_type'] == 'general') : ?>
                                    <span class=""><i class="fas fa-play-circle"></i>
                                        <?php
                                        $number_of_lessons = $this->crud_model->get_lessons_p('course', $course['id'])->num_rows();
                                        echo $number_of_lessons . ' ' . site_phrase('lessons');
                                        ?>
                                    </span>
                                    <span class=""><i class="far fa-clock"></i>
                                        <?php echo $this->crud_model->get_total_duration_of_lesson_by_programs_id($course['id']); ?>
                                    </span>
                                <?php endif; ?>
                ...
                <div class="course-price-rating">
                    ...
                    <div class="rating">
                        <?php
                        $total_rating =  $this->crud_model->get_ratings('programs', $course['id'], true)->row()->rating;
                        $number_of_ratings = $this->crud_model->get_ratings('programs', $course['id'])->num_rows();
                    ...
                    <div class="rating-number">
                        <?php echo $this->crud_model->get_ratings('programs', $course['id'])->num_rows() . ' ' . site_phrase('ratings'); ?>
                    </div>
                </div>
            </div>
        </li>
