...
<section class="purchase-history-list-area">
    <div class="container">
                        ...
                        <table class="padding text-left small border-bottom w-100">
                            <thead>
                                <tr class="gry-color" style="background: #eceff4;">
                                    <th width="50%"><?php echo (($course_details['type']==1)?'Course ':'Program ').'Title'; ?></th>
        ...
        <div class="d-print-none mb-2">
            <a href="javascript:window.print()" style = 'background: #f69f3b; color: white;font-style: normal;font-weight: 300;' class="btn btn-receipt float-end mt-2"> <i class="fa fa-print"></i> <?php echo site_phrase('print'); ?></a>
        </div>
    </div>
</section>
