                ...
                <div class="course-box">
                    ...
                    <div class="" id = "course_info_view_<?php echo $my_course['id'];  ?>">
                      <div class="course-details">
                          <a href="<?php echo site_url('home/program/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['id']); ?>"><h5 class="title"><?php echo ellipsis($course_details['title']); ?></h5></a>
                      ...
                      <div class="row" style="padding: 5px;">
                          <div class="col-md-6">
                              <a href="<?php echo site_url('home/program/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['id']); ?>" class="btn"><?php echo site_phrase('course_detail'); ?></a>
                          </div>
                          <div class="col-md-6">
