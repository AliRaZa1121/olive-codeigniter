        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-xl-6 order-last order-lg-first text-md-start text-center pt-4 ps-0">
                ...
                <p class="text-12px mt-3">
                    <?php echo $total_students . ' ' . site_phrase('trainee_enrolled'); ?>
                </p>
            </div>
            ...
            <div class="order-first order-lg-last col-lg-4 col-xl-3">
                <div class="row bg-white px-3 py-4 radius-8">
                    <div class="col-4 text-center">
                        ...
                        <p class="text-12px fw-700 text-muted"><?php echo site_phrase('total_Trainees'); ?></p>
                    </div>
                    <div class="col-4 text-center">
                        <h5 class="fw-700"><?php echo sizeof($course_ids); ?></h5>
                        <p class="text-12px fw-700 text-muted"><?php echo site_phrase('programs'); ?></p>
                    </div>
                    <div class="col-4 text-center">
                        <h5 class="fw-700"><?php echo count($this->crud_model->get_instructor_wise_course_ratings($instructor_id, 'course')); ?></h5>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-12 col-xl-10">
            <h3 class="course-carousel-title mb-4 px-2"><?php echo site_phrase('programs'); ?></h3>
            ...
            <!--<div class="course-carousel">
                ...
                ?>
                    <div class="course-box-wrap">
                        <a onclick="$(location).attr('href', '<?php echo site_url('home/program/' . rawurlencode(slugify($top_course['title'])) . '/' . $top_course['id']); ?>');" href="javascript:;" class="has-popover">
