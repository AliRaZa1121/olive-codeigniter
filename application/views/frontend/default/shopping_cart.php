...
<script type="text/javascript">
    ...
    function removeFromCartList_p(elem) {
        url1 = '<?php echo site_url('home/handleCartItems_p'); ?>';
        url2 = '<?php echo site_url('home/refreshWishList'); ?>';
        url3 = '<?php echo site_url('home/refreshShoppingCart'); ?>';
        $.ajax({
            url: url1,
        ...
        $.ajax({
            ...
            success: function(response) {
                if (!response) {
                    ...
                    toastr.error('<?php echo site_phrase('there_are_no_programs_/_carts_on_your_cart'); ?>');
                }
            }
        });
    }
        ...
        if(couponCode != ""){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(result.msg == 'valid'){
                        var amount =  $('#total_price_of_checking_out').text().replace('\n            ', '');
                        var discount_percent = result.data.discount_percentage;
