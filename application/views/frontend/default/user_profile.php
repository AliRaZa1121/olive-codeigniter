									...
									<form action="<?php echo site_url('home/update_profile/update_basics'); ?>" method="post">
										<div class="content-box">
											<div class="basic-group">
												...
												<div class="form-group">
													<label for="FristName"><?php echo site_phrase('email'); ?>:</label>
													<input disabled="disabled" type="text" class="form-control" name="email" placeholder="<?php echo site_phrase('email'); ?>" value="<?php echo $user_details['email']; ?>">
												</div>

												<div class="form-group">
													<label for="FristName"><?php echo site_phrase('username'); ?>:</label>
													<input disabled="disabled" type="text" class="form-control" name="username" placeholder="<?php echo site_phrase('username'); ?>" value="<?php echo $user_details['username']; ?>">
												</div>
												...
												<div class="form-group">
													<label for="country"><?php echo site_phrase('country'); ?>:</label>
