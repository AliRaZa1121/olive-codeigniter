                    ...
                    <div class="course-box-wrap">
                        <div class="course-box">
                            <div class="course-image">
                                <a href="<?php echo site_url('home/program/' . rawurlencode(slugify($my_course['title'])) . '/' . $my_course['id']); ?>"><img src="<?php echo $this->crud_model->get_course_thumbnail_url($my_course['id']); ?>" alt="" class="img-fluid"></a>
                            ...
                            <div class="course-details">
                                <a href="<?php echo site_url('home/program/' . rawurlencode(slugify($my_course['title'])) . '/' . $my_course['id']); ?>">
