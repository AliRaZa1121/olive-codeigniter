<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('coach_settings'); ?></h4>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('public_Coach_settings');?></h4>

                <form action="<?php echo site_url('admin/instructor_settings/update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label><?php echo get_phrase('allow_public_Coach'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="instructor_application_note"><?php echo get_phrase('Coach_application_note'); ?></label>
                        <div class="form-group">
                            <textarea class="form-control" name="instructor_application_note" rows="8" cols="80"><?php echo get_settings('Coach_application_note'); ?></textarea>
                        </div>
                    </div>
       ...
       <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('Coach_commission_settings');?></h4>

                <form action="<?php echo site_url('admin/instructor_settings/update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="acinstructor_revenue"><?php echo get_phrase('coach_revenue_percentage'); ?></label>
