...
$course_details = $this->crud_model->get_programs_by_id($param2)->row_array();
$sections = $this->crud_model->get_section_p('programs', $param2)->result_array();
?>
...
<form action="<?php echo site_url('admin/lessons_p/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="programs_id" value="<?php echo $param2; ?>">
