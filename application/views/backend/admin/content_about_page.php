    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php $section = $this->crud_model->get_content_settings('about', 'section-1'); ?>
                <form class="required-form" action="<?php echo site_url('admin/content_settings/about/section-1'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/content_settings/about/section-2'); ?>" method="post" enctype="multipart/form-data">
