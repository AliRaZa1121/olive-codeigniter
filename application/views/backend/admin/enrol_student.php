              ...
              <div class="col-lg-12">
                ...
                <form class="required-form" action="<?php echo site_url('admin/enrol_student/enrol'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="user_id"><?php echo get_phrase('trainees'); ?><span class="required">*</span> </label>
                    ...
                    <div class="form-group">
                        <label for="course_id"><?php echo get_phrase('program_to_enrol'); ?><span class="required">*</span> </label>
