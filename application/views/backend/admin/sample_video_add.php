    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="header-title my-1">Add New Sample Video</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/sample_video_actions/add'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="from-group mb-4">
								...
								<input type="file" class="form-control dropify" id="video" name="video" required>
