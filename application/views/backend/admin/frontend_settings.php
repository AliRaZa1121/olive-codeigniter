            ...
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="mid_title"><?php echo get_phrase('mid_title'); ?><span class="required">*</span></label>
                        <input type="text" name = "mid_title" id = "mid_title" class="form-control" value="<?php echo get_frontend_settings('mid_title');  ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="mid_sub_title"><?php echo get_phrase('mid_sub_title'); ?><span class="required">*</span></label>
                        <input type="text" name = "mid_sub_title" id = "mid_sub_title" class="form-control" value="<?php echo get_frontend_settings('mid_sub_title');  ?>" required>
                    </div>
