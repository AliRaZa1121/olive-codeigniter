    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php $section = $this->crud_model->get_content_settings('organizations', 'section-3'); ?>
                <form class="required-form" action="<?php echo site_url('admin/content_settings/organizations/section-3'); ?>" method="post" enctype="multipart/form-data">
