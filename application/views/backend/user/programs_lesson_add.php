...
<div class="alert alert-info" role="alert">
    ...
    <strong><a href="#" class="ml-1" data-toggle="modal" data-dismiss="modal" onclick="showAjaxModal('<?php echo site_url('modal/popup/programs_lesson_types/'.$param2.'/'.$param3); ?>', '<?php echo get_phrase('add_new_list'); ?>')"><?php echo get_phrase("change"); ?></a></strong>
</div>

<!-- ACTUAL LESSON ADDING FORM -->
<form action="<?php echo site_url('user/lessons_p/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label><?php echo get_phrase('do_you_want_to_keep_it_free_as_a_preview_list'); ?>?</label>
        <br>
        <input type="checkbox" name="free_lesson" id="free_lesson" value="1">
        <label for="free_lesson"><?php echo get_phrase('mark_as_free_list'); ?></label>
    </div>

    <div class="text-center">
        <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('add_list'); ?></button>
    </div>
</form>
