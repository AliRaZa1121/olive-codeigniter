<?php foreach($notice_list as $notice): ?>
	<div class="alert alert-success pb-1 pt-1" role="alert" id="notice_del_button_<?php echo $notice['id']; ?>">
	    <a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('addons/noticeboard/notice_details_p/'.$notice['id']); ?>', '<?php echo get_phrase('notice_details') ?>')" class="text-success"><strong><i class="mdi mdi-clipboard-arrow-right-outline"></i> <?php echo $notice['title']; ?> </strong></a>
