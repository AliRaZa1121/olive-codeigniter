            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo site_url('user/programs'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm my-1"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_programs_list'); ?></a>
                    </div>
                </div>
                            ...
                            <div id="basicwizard">
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <?php if (addon_status('noticeboard')) : ?>
                                        <li class="nav-item">
                                            <a href="#noticeboard" onclick="load_notic_form_p()" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                ...
                                <div class="tab-content b-0 mb-0">
                                    ...
                                    <div class="tab-pane" id="curriculum">
                                        ...
                                        if ($course_details['course_type'] == 'general') :
                                            include 'program_curriculum.php';
