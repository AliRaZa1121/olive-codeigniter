...
<div class="tab-pane" id="live-class">
    <div class="row">
        <div class="col-md-7">
            ...
            <!-- <div class="form-group row mb-3">
                <label class="col-md-4 col-form-label" for="live_class_schedule_data_time"><?php echo get_phrase('live_class_schedule') . ' (' . get_phrase('time') . ')'; ?></label>
                <div class="col-md-6">
                    <input type="text" name="live_class_schedule_data_time[]" id="live_class_schedule_data_time" class="form-control datetimepicker"  value="<?php echo date('h:i:s A', $live_class['time']); ?>">
                </div>
            </div> -->
