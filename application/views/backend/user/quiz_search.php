...
$questions = $this->crud_model->get_quiz_answer_student($param2)->result_array();
$e = $_GET['student_id'];
                                   ...
                                   <form class="row justify-content mt-2" action="<?php echo site_url('modal/popup/quiz_search/'.$quiz_details['id']); ?>" method="get">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="form-group">
                                                <label for="instructor_id"><?php echo get_phrase('Students'); ?></label>
                                        ...
                                        <div class="card mb-0 mt-2 draggable-item on-hover-action" id = "<?php echo $question['id']; ?>">
                                            <div class="card-body">
                                                <div class="media">
                                                    ...
                                                    <?php $answers = $this->crud_model->get_quiz_answers_filter($question['id'])->result_array(); 
                                                    $e = $_GET['student_id'];
                                                           if(($answers['user_id'] == $e)) 
                                                                        ...
                                                                        <table class="table table-striped dt-responsive nowrap" width="100%" >
                                                                            ...
                                                                            <tbody>
                                                                                  ...
                                                                                  <?php if($submited_answers == $corrected_answer): ?>
                                                                                        ...
                                                                                        <td> <?php if($ans['marks']){ echo $ans['marks']; } else{   ?><a href="javascript::" class="  text-secondary" onclick="showAjaxModal('<?php echo site_url('modal/popup/add_quiz_marks/'.$ans['id'].'/' . $param2); ?>', '<?php echo get_phrase('add_marks'); ?>')" data-dismiss="modal"><i class="dripicons-document-edit"></i></a>  <?php } ?></td>
