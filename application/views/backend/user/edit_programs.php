    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="header-title my-1"><?php echo get_phrase('programs_manager'); ?></h4>
                    </div>
                    <div class="col-md-6">
                        <a href="<?php echo site_url('user/preview/' . $programs_id); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm ml-1 my-1" target="_blank"><?php echo get_phrase('view_on_frontend'); ?> <i class="mdi mdi-arrow-right"></i> </a>

                        <a href="<?php echo site_url('user/programs'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm my-1"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_$programs_id_list'); ?></a>
                    </div>
                </div>

                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('user/programs_actions/edit/' . $programs_id); ?>" method="post" enctype="multipart/form-data">
                            <div id="basicwizard">
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <?php if (addon_status('programs_analytics')) : ?>
                                        <li class="nav-item">
                                ...
                                <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-6">
                                                    <div class="alert alert-warning" role="alert">
                                                        ...
                                                        <p><?= get_phrase('currently_the_scorm_programs_addon_is_deactivate'); ?>. <?= get_phrase('please_activate_the_scorm_programs_addon_to_use_it'); ?>.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <?php if (addon_status('noticeboard')) : ?>
                                        <div class="tab-pane" id="noticeboard">
                                            <?php include 'programs_noticeboard.php'; ?>
                                        </div>
                                    <?php endif; ?>
                                    <!-- NOTICEBOARD CODE BASE -->
                                    ...
                                    <?php if (addon_status('programs_analytics')) : ?>
                                        <div class="tab-pane" id="course_analytics">
                                            <?php include 'programs_analytics.php'; ?>
                                        </div>
                                    <?php endif; ?>
                                    <!-- COURSE ANALYTICS CODE BASE -->
                                            ...
                                            <div class="col-xl-8">
                                                <?php if (addon_status('scorm_course')) : ?>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label" for="course_type"><?php echo get_phrase('programs_type'); ?></label>
                                                        <div class="col-md-10">
                                                            <div class="alert alert-light" role="alert">
                                                                <h4 class="alert-heading"><?= get_phrase($course_details['course_type']); ?></h4>
                                                                <hr class="m-1">
                                                                <p class="mb-0"><?= get_phrase('the_programs_type_can_not_be_editable'); ?>.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="existing_instructors"><?php echo get_phrase('instructor_of_this_programs'); ?></label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_title"><?php echo get_phrase('programs_title'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_title" name="title" placeholder="<?php echo get_phrase('enter_programs_title'); ?>" value="<?php echo $course_details['title']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="is_top_course"><?php echo get_phrase('check_if_this_programs_is_top_programs'); ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="is_free_course"><?php echo get_phrase('check_if_this_is_a_free_programs'); ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="paid-course-stuffs">
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label" for="price"><?php echo get_phrase('programs_price') . ' (' . currency_code_and_symbol() . ')'; ?></label>
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control" id="price" name="price" min="0" placeholder="<?php echo get_phrase('enter_programs_price'); ?>" value="<?php echo $course_details['price']; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="discount_flag"><?php echo get_phrase('check_if_this_programs_has_discount'); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <small class="text-muted"><?php echo get_phrase('this_programs_has'); ?> <span id="discounted_percentage" class="text-danger">0%</span> <?php echo get_phrase('discount'); ?></small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                    ...
                                    <div class="tab-pane" id="media">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_overview_provider"><?php echo get_phrase('programs_overview_provider'); ?></label>
                                                    <div class="col-md-10">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_overview_url"><?php echo get_phrase('programs_overview_url'); ?></label>
                                                    <div class="col-md-10">
