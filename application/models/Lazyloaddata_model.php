...
class Lazyloaddata_model extends CI_Model
{
  ...
  function courses($limit, $start, $col, $dir, $filter_data)
  {
   ...
   function programs($limit, $start, $col, $dir, $filter_data)
  {
    // MULTI INSTRUCTOR COURSE IDS
    $multi_instructor_programs_ids = array();
    if ($filter_data['selected_instructor_id'] != "all") {
      $multi_instructor_programs_ids = $this->crud_model->multi_instructor_programs_ids_for_an_instructor($filter_data['selected_instructor_id']);
    }
  ...
  function course_search($limit, $start, $search, $col, $dir, $filter_data)
  {
   ...
   function programs_search($limit, $start, $search, $col, $dir, $filter_data)
  {
    // MULTI INSTRUCTOR COURSE IDS
    $multi_instructor_programs_ids = array();
    if ($filter_data['selected_instructor_id'] != "all") {
  ...
  function course_search_count($search)
  {
   ...
   function programs_search_count($search)
  {
    $query = $this
      ->db
      ->where('type',2)
  ...
  function count_all_programs($filter_data = array())
  {
    // MULTI INSTRUCTOR COURSE IDS
    $multi_instructor_programs_ids = array();
    if ($filter_data['selected_instructor_id'] != "all") {
